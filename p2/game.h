...
#define CLUB_OFFSET 0
#define CLUB_COUNT 1
#define PLAYER_OFFSET CLUB_OFFSET+CLUB_COUNT //1
#define PLAYER_COUNT 1
#define AXE_OFFSET PLAYER_OFFSET+PLAYER_COUNT //2
#define AXE_COUNT 4
#define CLUBS_OFFSET AXE_OFFSET+AXE_COUNT //6
#define CLUBS_COUNT 5
#define MONSTERS_OFFSET CLUBS_OFFSET+CLUBS_COUNT //11
#define MONSTERS_COUNT 12
#define BONUSES_OFFSET MONSTERS_OFFSET+MONSTERS_COUNT //23
#define BONUSES_COUNT 32
#define ITEMS_OFFSET BONUSES_OFFSET+BONUSES_COUNT //55
#define ITEMS_COUNT 50 //was 20
#define SCORES_OFFSET ITEMS_OFFSET+ITEMS_COUNT //75
#define SCORES_COUNT 16
#define DECOR_OFFSET SCORES_OFFSET+SCORES_COUNT //91
#define DECOR_COUNT 7
#define TREE_OFFSET DECOR_OFFSET+DECOR_COUNT //98
#define TREE_COUNT 5
#define PROJECTILES_OFFSET TREE_OFFSET+TREE_COUNT //103
#define PROJECTILES_COUNT 5
#define BARS_OFFSET PROJECTILES_OFFSET+PROJECTILES_COUNT //108
#define BARS_COUNT 8
#define OBJECTS_COUNT BARS_OFFSET+BARS_COUNT //116
/*
 offset count
      0     1 : club
      1     1 : player
